...
- [RenameEnum(oldName, newName string, opts ...schema.RenameEnumOptions)](https://pkg.go.dev/github.com/alexisvisco/amigo/pkg/schema/pg#Schema.RenameEnum)

- [RenameEnumValue(name, oldName, newName string, opts ...schema.RenameEnumValueOptions)](https://pkg.go.dev/github.com/alexisvisco/amigo/pkg/schema/pg#Schema.RenameEnumValue)
